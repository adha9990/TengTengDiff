...
def parse_args():
    ...
    parser.add_argument("--model_dir", type=str, default="./models/u2net.pth")
...
def main(args):
    ...
    if(args.model_dir.endswith('u2net.pth')):
        model_name='u2net'
    elif(args.model_dir.endswith('u2netp.pth')):
        model_name='u2netp'
    else:
    ...
    for i_test, data_test in enumerate(test_salobj_dataloader):
        ...
        save_output(img_name_list[i_test], pred, args.output_dir)
